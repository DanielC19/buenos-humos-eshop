...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.productCategory.create') }}" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.productCategory.edit', $category->id) }}"
                                               class="btn btn-outline-primary"
                                               title="{{ __('Edit') }}">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('admin.productCategory.destroy', $category->id) }}"
                                                  method="POST"
